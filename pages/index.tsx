            ...
            <div className="listHowToBuy">
              <div className="contentText copy">
                ...
                <p>
                  ...
                  nghiệm trong ngành luôn sẵn lòng giúp Quý khách tìm được chiếc
                  xe ưng ý cũng như hỗ trợ Quý khách các thủ tục mua xe trả góp,
                  đóng thuế, đăng ký, đăng kiểm xe…
                </p>
                <h2>GIÁ TỐT NHẤT – GIAO XE NHANH</h2>
                <p>
                  Chúng tôi cam kết luôn mang lại mức giá tốt và nhiều ưu đãi
                  nhất cho Quý khách cùng với thời gian giao xe sớm nhất tại khu
                  vực phía Nam.
                </p>
              </div>
              <div className="contentText copy">
