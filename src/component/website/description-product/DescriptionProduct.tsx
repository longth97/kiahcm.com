  ...
  return (
    <div className="descriptionProduct">
      ...
      <div className="btnGroup">
        <PrimaryButton text="đăng ký lái thử" href="/lien-he"></PrimaryButton>
        <span className="margin"></span>
        <PrimaryButton text="Báo giá cho tôi" href="/lien-he"></PrimaryButton>
      </div>

      <div className="codeProduct">
        <h4>
          Mã : <span>{props.codeProduct}</span>
        </h4>
      </div>
